...
#window,
riskyspread=0.1,
miniumbidinterval=0.01
miniumaskinterval=0.01
...
def run(s):
    for instrument in instruments:
        if instrument.symbol == s:
            ...
            longbias = max(min(0.1 * (1.0 - p), 0.1), miniumbidinterval)
            shortbias = max(min(0.1 * p, 0.1), miniumaskinterval)
            flag1=0
            flag2=0
            ...
            #                                            common_pb2.LONG)
            if mktposition.unrealizedPnllong[instrument.symbol] < -2000 or mktposition.unrealizedPnllong[
                instrument.symbol] > 2000 or mktposition.occupiedcashlong[instrument.symbol] > 15000 or mktposition.marketLongPosition[instrument.symbol]>400:
                # utils.new_order(common_pb2.NEW_ORDER, None, common_pb2.ASK, instrument.symbol,
                #                 mktposition.marketLongPosition[instrument.symbol], None,
                #                 True, common_pb2.LONG)
                orders[instrument.symbol].insert_order(common_pb2.ASK, instrument.symbol,
            ...
            #                                            meanp[instrument.symbol] + shortbias, True,
            #                                            common_pb2.SHORT)
            if mktposition.unrealizedPnlshort[instrument.symbol] < -2000 or mktposition.unrealizedPnlshort[
                instrument.symbol] > 2000 or mktposition.occupiedcashshort[instrument.symbol] > 15000 or mktposition.marketShortPosition[instrument.symbol]>400:
                # utils.new_order(common_pb2.NEW_ORDER, None, common_pb2.BID, instrument.symbol,
                #                 mktposition.marketShortPosition[instrument.symbol], None,
                #                 True, common_pb2.SHORT)
                orders[instrument.symbol].insert_order(common_pb2.BID, instrument.symbol,
    ...
    while 1:
        ...
        for market_data in response:
            ...
            break
                    ...
                    #                     mktposition.marketLongPosition[instrument.symbol],None,
                    #                     True,common_pb2.LONG)
                    # if mktposition.unrealizedPnllong[instrument.symbol]<-500 or mktposition.unrealizedPnllong[instrument.symbol]>500:
                    #     utils.new_order(common_pb2.NEW_ORDER, None, common_pb2.ASK, instrument.symbol,
                    #                     mktposition.marketLongPosition[instrument.symbol], None,
                    #                     True, common_pb2.LONG)
                    #
                    ...
                    #                     mktposition.marketShortPosition[instrument.symbol],None,
                    #                     True,common_pb2.SHORT)
                    # if mktposition.unrealizedPnlshort[instrument.symbol]<-500 or mktposition.unrealizedPnlshort[instrument.symbol]>500:
                    #     utils.new_order(common_pb2.NEW_ORDER, None, common_pb2.BID, instrument.symbol,
                    #                     mktposition.marketShortPosition[instrument.symbol], None,
                    #                     True, common_pb2.SHORT)
                    #
